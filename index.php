            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    if($page == 'masuk') {
                        ...
                        <h2>Dashboard</h2>   
                        <h5>Selamat Datang <strong><?= $_SESSION['admin']['nama']; ?></strong> Di Aplikasi Kas Sekolah. | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
                        </h5>
                        <hr>
                        <div class="row">
